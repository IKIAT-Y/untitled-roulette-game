...
public class MirrorCharm extends AbstractCharm {
    ...
    private TileType copyTileType(TileType sourceType, Tile target) {
        ...
        if (sourceType instanceof VoidTile) {
            VoidTile voidTile = (VoidTile) sourceType;
            return new VoidTile(copyTileType(voidTile.getOriginalType(), target), target);
        }
